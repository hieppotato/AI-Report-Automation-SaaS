...
from app.schemas.billing import CheckoutCreate, CheckoutResponse, CurrentPlanResponse, CustomerPortalResponse
...
def customer_portal(
    ...
    portal_url = service.get_customer_portal_url(payload.organization_id, current_user.id)
